...
class LLMClient(ABC):
    @abstractmethod
    def generate_commit_message(self, prompt: str | list) -> Tuple[str, Optional[Dict[str, int]]]:
        """
    ...
    def stream_commit_message(self, prompt: str | list) -> Generator[Tuple[str, Optional[Dict[str, Any]]], None, None]:
        """
